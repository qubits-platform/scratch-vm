...
const EXTENSION_ID = "qubitsaimodel";
...
class Scratch3VideoSensingBlocks {
    ...
    _loop() {
        ...
        if (this.isText()) {
            ...
            offset > Scratch3VideoSensingBlocks.INTERVAL &&
            this._isPredicting === 0
        ) {
    ...
    getInfo() {
        ...
        const blocks = [
            {
                ...
                arguments: {
                    MODEL_URL: {
                        ...
                        defaultValue:
                            this.teachableImageModel || "Paste URL Here!",
                    },
                },
            },
            {
            ...
            },
            {
                ...
                text: formatMessage({
                    ...
                    description:
                        "Boolean that is true when the model matches [CLASS_NAME]",
                }),
        ...
        return {
            id: EXTENSION_ID,
            name: formatMessage({
                id: "qubitsAIModels.categoryName",
                default: "Qubits AI Models",
                description:
                    "Label for the Qubits AI Models extension category",
            }),
